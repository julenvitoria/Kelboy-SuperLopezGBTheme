...
if [ -d "/home/pi/.emulationstation/themes/SuperLopezGB/" ]; then
        ...
        sudo mkdir -p "/home/pi/.emulationstation/themes/SuperLopezGB/" && sudo git clone https://github.com/mlopezmad/SuperLopezGB "/home/pi/.emulationstation/themes/Super Retroboy/" --branch master --depth=1
...
git clone https://github.com/mlopezmad/SuperLopezGB-Launching "/home/pi/tmp" --branch master --depth=1
